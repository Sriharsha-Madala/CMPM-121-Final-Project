Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi Toon/72b8b52451ab1264195cca8710c6988d"
{
	Properties
	{
 ...
 #define POI_VERTEXLIGHT_ON 
			...
			{
				float3 viewDirection = normalize(lerp(getCameraPosition().xyz, _WorldSpaceCameraPos.xyz, float(0)) - poiMesh.worldPos.xyz) * - 1;
				return lerp(MonoPanoProjection(viewDirection), StereoPanoProjection(viewDirection), float(1));
			}
